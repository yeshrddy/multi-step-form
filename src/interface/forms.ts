...
export interface RequisitionDetailsFormProps {
  setTabIndex: Dispatch<SetStateAction<number>>; // Use Dispatch and SetStateAction types
}
...
export interface InterviewDetailsFormProps {
  setTabIndex: Dispatch<SetStateAction<number>>; // Use Dispatch and SetStateAction types
}
